...
engine to group them together in a group box, as shown. For more
information about Frontend tags see
link:../Reference/Tags.adoc#FTRTagsDescriptions-FrontendTags[Frontend Tags].
...
=== Creating a FormHow toCreating a FormForm, CreatingHow toDataphoria
DesignerDataphoria DesignerCreating an Entry Form
...
Dataphoria windows will look approximately like this.
...
=== Customizing a FormHow toCustomize a FormForm, CustomizingCreating a
Filter on a formHow toCreating a Filter on a formCustomizing a Form, add
a Filter
