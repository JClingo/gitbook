...
* link:D4LGCatalogElements-ScalarTypes.html[System.Scalar]
+
...
link:D4LGCatalogElements-Conversions.html[Conversions].
...
link:D4LGCatalogElements-ScalarTypes.html[Catalog Elements, Scalar
Types] | link:DRSystemLibrary-ScalarTypes.html[Dataphor Reference,
Scalar Types]
...
link:D4LGCatalogElements-TableVariables.html[Table Variables]
...
link:D4LGCatalogElements-ScalarTypes.html[Scalar Types].
...
have been called __link:D4LGCatalogElements-TableVariables.html[table
variables]__, and indeed we refer to them as such throughout the
...
link:D4LGCatalogElements-Operators.html[Catalog Elements, Operators]
...
link:D4LGCatalogElements.html[Catalog Elements].
...
rule see link:D4LGTableExpressions.html[Table Operators].
...
Each link:D4LGCatalogElements-Operators.html[operand] in the signature
