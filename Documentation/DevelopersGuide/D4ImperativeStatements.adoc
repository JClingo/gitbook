...
The <<D4LGLanguageElements.adoc#D4LGLanguageElements-Types, <type specifier>>>
...
<<D4LGLanguageElements.adoc#D4LGLanguageElements-Expressions, <expression>>> must be
...
<<D4LGLanguageElements.adoc#D4LGLanguageElements-Expressions, <expression>>>
must be boolean-valued. If the expression evaluates to true, the statement given
by <<D4LGLanguageElements.adoc#D4LGLanguageElements-Statements, <statement>>> is executed.
...
| link:D4LGBreakandContinue.html[Break and Continue]
...
<<D4LGImperativeStatements-ExceptionHandling-TryExceptStatement.html[exception trap]>>
